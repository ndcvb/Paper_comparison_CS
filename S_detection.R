...
original_cs = original_cs %>% select("Watercontactsite",'date', "initial_time", "final_time") 
...
cs_data <- cs_data %>% select(-month, -NDVI_med_t,-initial_time,-final_time,-final_timeX)
